...
def read_corpus(src_file, tgt_file, max_len, min_len=0):
...
class Translator:
    ...
    def train(self, source, target, num_epochs):
        """
        ...
        train_pairs, val_pairs = train_val_split(read_corpus(source, target, max_len=50))
...
def main():
    ...
    if args.train is not None:
        ...
        translator.train(train_source, train_target, num_epochs=args.n_epochs)
        ...
        with open(train_source, 'r', encoding='utf-8') as f:
            ...
            for _ in range(5):
                ...
                print(f"> Translation: {translator.translate(sentence, args.max_len)}\n")
